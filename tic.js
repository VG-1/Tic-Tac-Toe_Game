...
// }
// document.turn = "X";
// if(Math.random()< 0.5)   /*in built function in js to generate random number*/
// {
//     document.turn = "0";
// }
// document.winner = null;
// setMessage(document.turn + " gets to staer. ");
...
// {
//     var result = false;
//     if(checkRow(1,2,3, move) || checkRow(7,8,9, move) || checkRow(7,8,9, move) ||checkRow(1,4,7, move) ||checkROw(2,5,8,) || checkRow (3,6,9, move) || checkRow(1,5,9, move) ||  checkRow(7,8,9, move))
// {
//     result = true;
// }
// return result;
...
// {
//     document.getElementById.ElementById("s"+ number).textContent = "";
// }
